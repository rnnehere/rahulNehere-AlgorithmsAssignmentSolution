...
import service.BinarySearchDouble;
import service.MergeSortDouble;
...
public class DriverClass 
{
	...
	public static void main(String[] args) 
	{
		...
		int choice = -1;
		MergeSortDouble mObj = new MergeSortDouble(sharePrices, companies);
		...
		do 
		{
			...
			switch(choice) 
			{
				...
				case 5: System.out.println("Enter the key value");
						...
						BinarySearchDouble bObj = new BinarySearchDouble(ascendingShares, companies);
